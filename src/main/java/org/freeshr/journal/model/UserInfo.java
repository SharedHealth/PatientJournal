...
public class UserInfo {
    ...
    private void loadProviderProperties(UserProfile userProfile) {
        if (userProfile.isProvider()) {
            ...
            if (!CollectionUtils.isEmpty(userProfile.getCatchments())) {
    ...
    public boolean equals(Object o) {
        ...
        if (catchments != null ? !catchments.equals(userInfo.catchments) : userInfo.catchments != null)
            return false;
        if (!email.equals(userInfo.email)) return false;
        if (facilityId != null ? !facilityId.equals(userInfo.facilityId) : userInfo.facilityId != null)
            return false;
        if (groups != null ? !groups.equals(userInfo.groups) : userInfo.groups != null)
            return false;
        if (!id.equals(userInfo.id)) return false;
        if (name != null ? !name.equals(userInfo.name) : userInfo.name != null)
            return false;
        if (patientHid != null ? !patientHid.equals(userInfo.patientHid) : userInfo.patientHid != null)
            return false;
        if (providerId != null ? !providerId.equals(userInfo.providerId) : userInfo.providerId != null)
            return false;
